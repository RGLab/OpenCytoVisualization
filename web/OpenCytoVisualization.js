...
//        },
        ...
        LABKEY.Report.getSessions({
            success: function( responseObj ){
                ...
                for ( i = 0; i < length; i ++ ){
                    if ( array[i].clientContext == 'OpenCytoVisualization' ){
                ...
                if ( i == length ){
                    LABKEY.Report.createSession({
                        clientContext : 'OpenCytoVisualization',
...
/////////////////////////////////////
        ...
        function onStrFilteredTableLoad(){
            ...
            newColumns = [
                LABKEY.ext.OpenCyto.factoryRowNumberer( strFilteredTable ),
                smCheckBox,
                {
                    dataIndex: 'name',
                    dragable: false,
            ...
            if ( AnalysisPath != selectedAnalysisPath ){
                ...
                LABKEY.Query.selectRows({
                    ...
                    failure: function(e, r, o){
                        ...
                        LABKEY.ext.OpenCyto.onFailure(e, r, o);
                    },
                    filterArray: [
